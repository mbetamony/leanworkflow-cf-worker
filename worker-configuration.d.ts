/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b713d59f3d3c2850afe05c9b30d7b1f2)
// Runtime types generated with workerd@1.20260831.1 2026-09-03 
interface __BaseEnv_Env {
	INGEST_SECRET: string;
	ALLOWED_ORIGINS: string;
	SUBMISSION: DurableObjectNamespace<import("./src/index").Submission>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "Submission";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "INGEST_SECRET" | "ALLOWED_ORIGINS">> {}
}
